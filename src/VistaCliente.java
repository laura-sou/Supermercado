...
public class VistaCliente extends JFrame {
    ...
    public VistaCliente() {
        ...
        inventario.cargarProductosDesdeCSV(csvPath);
        ...
        tablaModeloCarrito = new DefaultTableModel(
            new String[]{"Código", "Nombre", "Categoría", "Precio unitario", "Vence en...", "Cantidad", "Precio total"}, 0);
        ...
        btnPagar.addActionListener(e -> pagar()); // puedes definir acción de pago aquí
    ...
    private void actualizarCampoBusqueda() {
        ...
        if(!esCombo) {
            cardLayout.show(panelTipoBusqueda, "txtBusqueda");
        } else {
            cardLayout.show(panelTipoBusqueda, "comboBusquedaEspecial");
        }
        */
    ...
    private void anadirACarrito() {
        ...
        if (row != -1) {
            ...
            if (cantidad > 0) {
                ...
                tablaModeloCarrito.addRow(new String[]{
                    codigo, nombre, categoria, precio, vencimiento, String.valueOf(cantidad), String.valueOf(precioTotal)
                });
                calcularTotal();
            }
        }
    ...
    private void pagar() {
        ...
        if (total == 0) {
            JOptionPane.showMessageDialog(this, "¡No tienes nada en tu carro de compras!");
        } else {
            String confirmacionMsj = String.join(" ", "¿Desea pagar $", String.valueOf(total), "?");
            int confirmacion = JOptionPane.showConfirmDialog(this, confirmacionMsj, "", JOptionPane.YES_NO_OPTION);
            
            if (confirmacion == JOptionPane.YES_OPTION) {
                VistaPago pago = new VistaPago(total);
